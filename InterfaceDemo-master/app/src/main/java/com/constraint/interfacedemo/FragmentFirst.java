 ...
 */
public class FragmentFirst extends Fragment implements InterfaceModelClass.OnCustomStateListener {
    ...
    public void onAttach(Context context) {
        ...
        InterfaceModelClass.getInstance().setListener(this);
    }
    ...
    public void implementForFirstFragment() {
        Toast.makeText(getActivity()," call second ativity method in first activity's first fragment ",Toast.LENGTH_SHORT).show();
    }
